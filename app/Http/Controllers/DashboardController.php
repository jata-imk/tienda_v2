...
class DashboardController extends Controller
{
     ...
     * product-size combinations and inventory KPIs in a single payload.
     *
     ...
     *
     * @response 200 {"ok":true,"code":200,"status":"OK","message":"Dashboard retrieved.","data":{"topProducts":[],"lowestStock":[],"highestStock":[],"criticalStockBySize":[{"product":"Filipina caballero","key":"FIL-001","size":"G","stock":2}],"summary":{"totalProducts":0,"activeProducts":0,"totalVariants":0,"totalStock":0,"inventoryValue":0,"lowStockCount":0,"outOfStockCount":0}}}
     */
